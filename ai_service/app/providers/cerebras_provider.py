"""
Cerebras provider — ultra-fast inference (900+ tokens/sec), free tier.
Model: llama-3.3-70b (same quality as Groq but faster on free tier).
Base URL: https://api.cerebras.ai/v1  (OpenAI-compatible)
Key: CEREBRAS_API_KEY from .env
